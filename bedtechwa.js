...
function checkbtns(){
  if (btnbanding && btncornerProtectorsUse && btnShrinkWrapped && btnboxes && doublecheck){
    return true;
  }
...
async function submitForm(){
    ...
    formData.append('warehouse', "Bedtech - WA");
    formData.append('sendTo', "portland@bedtech.com, portlandoffice@bedtech.com, jodee@bedtech.com"); //portland@bedtech.com, portlandoffice@bedtech.com, jodee@bedtech.com
    formData.append('customerID', "51674-P1");
