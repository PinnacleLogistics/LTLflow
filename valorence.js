      ...
      const palletDiv = `
        <div class="pallet-info palletContainer">
          ...
          <div class="input_containers">
            <span class="weight-display">Pallet on Scale with Weight Display Visible</span>
          ...
          <div class="input_containers">
            <span class="weight-display">Packing List with Weight Display Visible</span>
...
function checkbtns(){
  if ( btnbanding && btncornerProtectorsUse && btnShrinkWrapped && btnboxes && overhang && leaning &&doublecheck){
    return true
  }
...
function btn(){
   ...
   $('#btnNoOverhang').on('click', function() {
    ...
    $('#btnYesLeaning').on('click', function() {
      $('#btnYesLeaning').css('background-color', '#00FF94');
      $('#btnNoLeaning').css('background-color', '#D9D9D9');
      leaning = 'Yes'
    })

   $('#btnNoLeaning').on('click', function() {
    $('#btnNoLeaning').css('background-color', '#FF8787');
    $('#btnYesLeaning').css('background-color', '#D9D9D9');
    leaning = 'No'
   })
    $('#btndoublecheckYes').on('click', function() {
      $('#btndoublecheckYes').css('background-color', '#00FF94');
      $('#btndoublecheckNo').css('background-color', '#D9D9D9');
      doublecheck = 'Yes'
   })
   $('#btndoublecheckNo').on('click', function() {
    $('#btndoublecheckNo').css('background-color', '#FF8787');
    $('#btndoublecheckYes').css('background-color', '#D9D9D9');
      doublecheck = 'No'
   })
